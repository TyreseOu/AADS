...
class BertEncoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = BertModel.from_pretrained('bert-base-uncased', local_files_only=True)
...
class RobertaEncoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = RobertaModel.from_pretrained('codeBERT', local_files_only=True)
...
class DistilRobertaEncoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = RobertaModel.from_pretrained('distilroberta-base', local_files_only=True)
        self.pooler = nn.Linear(param.hidden_size, param.hidden_size)
